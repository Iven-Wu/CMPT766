...
def test_chamfer(distChamfer, dim):
    points1 = torch.rand((4, 100, dim), device="cuda")
    points2 = torch.rand(4, 200, dim, requires_grad=True, device="cuda")
...
def timings(distChamfer, dim):
    p1 = torch.rand((32, 2000, dim), device="cuda")
    p2 = torch.rand((32, 1000, dim), device="cuda")
